...
<div class="product-main">
	 <div class="container">
	  ...
	  <table border="100px" cellpadding="100" cellspacing="100" width="100" height="70" rules="all">
	                  <tr>
            ...
            <% }
					 	...
					 	买家电话：<input type="text" name="…" value="<%=order.getUser().getPhone()%>"></br></br> 
								...
								收货地址：<input type="text" name="…" value="<%=order.getUser().getAddress()%> "></br></br>
								商品总价	：<%=request.getAttribute("sum")%>元</br></br>
							
								 		
				    <form>
							选择支付方式：<input type="radio" name="paystyle" value="支付宝" checked="checked"/>支付宝
                                         <input type="radio" name="paystyle" value="借记卡" />微信
