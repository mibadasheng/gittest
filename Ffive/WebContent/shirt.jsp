...
<div class="header">
	 <div class="container">
	     <div class="main-header">
			 ...
			 <div class="box_1">				 
				 <a href="cart.jsp"><h3>购物车: <span class="simpleCart_total"></span> (<span id="simpleCart_quantity" class="simpleCart_quantity"></span> )<img src="images/cart.png" alt=""/></h3></a>
	 ...
	 <div class="container">
		 ...
		 <div class="col-md-11 product-model-sec"  align="left">
             ...
             GoodsDAO itemsDao=new GoodsDAO();
			   ArrayList<Goods>  list= itemsDao.getItemsbytypeid("3");
              for(Goods u : list)  
           ...
           %>        
					 ...
					 <a href="single.jsp"><div class="product-grid love-grid">
						...
						<button class="btns"><a href="single.jsp?id=<%=item.getGoodid() %>">ORDER NOW </a> </button>
						    </h4>
							</div>
						</div></a>					
...
<div class="fotter-logo">
	 <div class="container">
	 <div class="ftr-logo"><h3><a href="FIVE.html">FIVE FLOWERS</a></h3></div>
	 <div class="ftr-info">
