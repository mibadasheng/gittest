				...
				<div class="box_1">
					<a href="cart.html"><h3>
							购物车: <span class="simpleCart_total"></span> (<span
								id="simpleCart_quantity" class="simpleCart_quantity"></span> )<img
								src="images/cart.png" alt="" />
						</h3></a>
					<p>
							...
							<div class="col1">
								<div class="h_nav">
									...
									<ul>
										...
										<li><a href="decorations.html">内衣</a></li>
...
<form id="cartForm">
			 ...
			 <script>$(document).ready(function(c) {
			   ...
			   -->
				...
				<div class="cart-header2">
					...
					<div class="cart-sec">
						<div class="cart-item">
							<img src="images/shirt/b1.jpg" />
						</div>
						<div class="cart-item-info">
							<h3>
								配腰带外套<span>商品号: 8768</span>
							</h3>
							<h4>
								<span>单价. $ </span>100.00
							</h4>
			...
			<div class="col-md-3 cart-total">
				...
				<div class="price-details">
					<h3>价格详情</h3>
					<span>总价</span> <span class="total">350.00</span> <span>折扣</span> <span
						class="total">---</span> <span>运费</span> <span class="total">10.00</span>
					<div class="clearfix"></div>
				</div>
				<h4 class="last-price"></h4>
				<span class="total final">360.00</span>
				<div class="clearfix"></div>
				<!--  <form action="cart.do?action=tijiao method="post">-->
							
				<button  type="submit" form="cartForm" formaction="order.do" formmethod="post"> 提交</button>
